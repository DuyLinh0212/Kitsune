// Kitsune.Web/Kitsune.Web.Admin/src/app/features/admin/pages/exams/exam-create.component.ts
...
import {
  ...
  ExamQuestionInput,
  ExamQuestionType
} from '../../../../core/services/exam-admin.service';
...
export class ExamCreateComponent {
  ...
  submitManual(): void {
    ...
    const input: CreateExamInput = {
      ...
      isPublic: false, // Đề admin tạo mặc định ẩn (draft); tự bật công khai trong trang quản lý.
      questions
    };
