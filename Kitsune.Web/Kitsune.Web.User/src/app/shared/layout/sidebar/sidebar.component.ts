...
export class SidebarComponent implements OnInit {
  ...
  readonly navItems: NavItem[] = [
    ...
    { id: 12, label: 'Ngữ pháp', icon: 'grammar', route: '/grammar', matchPrefix: '/grammar' },
  ...
  svgIcon(name: string): string {
    const icons: Record<string, string> = {
      ...
      grammar: `<path d="M4 7V5a1 1 0 011-1h14a1 1 0 011 1v2"/><path d="M9 20h6"/><path d="M12 4v16"/>`,
      exam: `<path d="M9 2h6a2 2 0 012 2v0a2 2 0 01-2 2H9a2 2 0 01-2-2v0a2 2 0 012-2z"/><path d="M16 4h2a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V6a2 2 0 012-2h2"/><path d="M9 14l2 2 4-4"/>`,
